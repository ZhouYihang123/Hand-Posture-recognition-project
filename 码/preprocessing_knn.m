function [feature, label, user, V, mstd] = preprocessing_knn(filename, pca_dimention, threshold, test, v, type, mstd)
...
for i=1:height
    ...
    if (type==2)||(type==1)
        ...
        feature(i,14) = skewness(Data_3d(i,1:3:(count*3-2)));    % feature11 = x mean
        feature(i,15) = skewness(Data_3d(i,2:3:(count*3-1)));    % feature12 = y mean
        feature(i,16) = skewness(Data_3d(i,3:3:(count*3)));      % feature13 = z mean
    end
    count=0;
end
